...
set DOWNLOAD_URL=https://github.com/horsicq/DIE-engine/releases/download/Beta/die_win64_qt6_portable_3.11_x64.zip
set DOWNLOAD_FILE=die_win64_qt6_portable_3.11_x64.zip
